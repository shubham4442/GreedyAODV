...
// I will drop in code of GPSr to do greedy routing for RREQ and rest remains same
// what to do for Beacon message of GPS exchange?
//Do I need to purge niegbours?
// handling mode via message class...AODV or Greedy
//
...
class INET_API Aodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    ...
    //global q-table
    // exporting in finish method, importing in constructor or initialization
    // what could be parameters for state - extent of concavity, remaining distance, nb of neighbours, size of radius 

    // Reinforcement Learning
    QTable & qTable = SIMULATION_SHARED_VARIABLE(qTable); 
    Coord destPos;
